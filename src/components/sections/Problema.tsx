  ...
  return (
    <section className="section-wrap-white">
      <div className="inner">
        ...
        {/* ── Situación actual ─────────────────────────────── */}
        <div id="situacion-actual" className="scroll-mt-20">
          <FadeIn>
        ...
        {/* ── Evolución histórica ──────────────────────────── */}
        <div id="evolucion-historica" className="scroll-mt-20 mb-12">
          <FadeIn>
        ...
        {/* ── Esperanza de vida ────────────────────────────── */}
        <div id="esperanza-de-vida" className="scroll-mt-20 mb-12">
          <FadeIn>
          ...
          <FadeIn>
            <div className="grid grid-cols-3 gap-4 mb-4">
              {[
                { yr: "1950", num: "66", sub: "años — Uruguay", bg: "bg-[#FEF0EC] border border-warn/25", numColor: "text-warn", badge: "text-warn" },
        ...
        <div id="evidencia-internacional" className="scroll-mt-20 mb-10">
          <FadeIn>
            <div className="bg-[#F5F2EA] border border-black/[.06] rounded-3xl p-7 mb-8">
        ...
        {/* Internal links */}
        <div className="pt-8 border-t border-black/[.06]">
          <p className="text-[13px] text-t3 mb-5 font-medium">Explorá más sobre tu futuro financiero:</p>
          <div className="flex flex-wrap gap-3">
            ...
            <Link
              href="/dominion"
              className="inline-flex items-center gap-2 border border-g3/40 text-g3 text-[13px] font-semibold rounded-full px-5 py-2.5 hover:bg-g3/[.06] transition-colors"
            >
              Conocé El Plan
            </Link>
            <Link
              href="/educacion"
              className="inline-flex items-center gap-2 border border-black/[.1] text-t2 text-[13px] font-semibold rounded-full px-5 py-2.5 hover:border-black/20 transition-colors"
            >
