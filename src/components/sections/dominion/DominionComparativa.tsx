...
const ROWS = [
  { feature: "Rendimiento histórico promedio", invertite: "+10% anual (S&P 500)", banco: "2–4% caja de ahorro", afap: "3–6% variable" },
  { feature: "Cuenta a tu nombre", invertite: "✓ Segregada", banco: "✗ Depósito bancario", afap: "✓ Individual" },
  { feature: "Exposición global", invertite: "✓ S&P 500, MSCI World", banco: "✗ Local/regional", afap: "Limitada" },
  { feature: "Liquidez", invertite: "✓ Disponible", banco: "✓ Inmediata", afap: "✗ Solo al retiro" },
  { feature: "Asesor personal", invertite: "✓ Regulado BCU", banco: "Limitado", afap: "✗ No" },
  { feature: "Voluntario", invertite: "✓", banco: "✓", afap: "✗ Obligatorio" },
];
              ...
              <thead>
                <tr>
                  ...
                  <th className="text-center pb-4 px-4">
                    <div className="bg-g3 text-white text-[12px] font-bold px-4 py-2 rounded-full inline-block">INVERTITE</div>
                  </th>
              ...
              <tbody>
                {ROWS.map((row, i) => (
                  <tr key={row.feature} className={i % 2 === 0 ? "bg-[#F8F6F0]" : "bg-white"}>
                    ...
                    <td className="text-[13px] font-semibold text-g3 py-4 px-4 text-center">{row.invertite}</td>
